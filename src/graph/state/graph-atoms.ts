import { GraphEdge, GraphRoot } from "../graph-types.js";
import { atom } from "jotai";
import { createEmptyGraph } from "../graph-util.js";
...
export const graphNodeIdsAtom = atom((get) => [
  ...get(graphNodeMapAtom).keys(),
]);

export const graphNodesAtom = atom((get) => [
  ...get(graphNodeMapAtom).values(),
]);
...
export const graphEdgeIdsAtom = atom((get) => [
  ...get(graphEdgeMapAtom).keys(),
]);

export const graphEdgesAtom = atom((get) => [
  ...get(graphEdgeMapAtom).values(),
]);
